var Menu = {
    create: function () {
        ...
        bg.scale.setTo(2);
        var logo = dgame.add.sprite(40, 128, "menu_logo");
        logo.scale.setTo(2);
        dgame.add.button((GAME_WIDTH - dgame.cache.getImage("menu_play").width / 2 ) / 2, 1184, "menu_play", function () {
            dgame.state.start(SCENE_GAME);
        }, this, 1, 0, 1, 0);

        dgame.add.button(148, 1488, "menu_rank", function () {
            boxRank();
            soundClick();
        }, this, 1, 0, 1, 0);
        dgame.add.button(444, 1572, "menu_gift", function () {
            boxCartGift();
            soundClick();

        }, this, 1, 0, 1, 0);
        dgame.add.button(760, 1488, "menu_tutorial", function () {
            boxRule();
            soundClick();
        }, this, 1, 0, 1, 0);
